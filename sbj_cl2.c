...
// ALL TYPES OF SBJ INCLUDED (e.g. null subjects)
...
1: {
       SubTOP: ((IP-MAT*|IP-SUB* idomsfirst NP-LFD*)					
       	  AND (IP-MAT*|IP-SUB* iDoms NP-SBJ-RSP*)
                AND (IP-MAT*|IP-SUB* iDoms AJ|EJ|LJ|MDJ|VJ)
                AND (NP-SBJ* precedes AJ|EJ|LJ|MDJ|VJ))
       SubTOP2: ((IP-MAT*|IP-SUB* idomsfirst NP-LFD*)					
       	  AND (IP-MAT*|IP-SUB* iDoms NP-SBJ-RSP*)
                AND (IP-MAT*|IP-SUB* iDoms AJ|EJ|LJ|MDJ|VJ)
                AND (AJ|EJ|LJ|MDJ|VJ precedes NP-SBJ*))
       xxx: ELSE
}
...
4: {
	lexS: (NP-SBJ-RSP iDoms NC*|D*|NPR*)
	nullS: (NP-SBJ-RSP iDoms \*pro\*)
	pronS: (NP-SBJ-RSP iDoms PRO*)
	quantS: (NP-SBJ-RSP iDoms Q)
	arbS: (NP-SBJ-RSP iDoms \*arb\*)
	conS: (NP-SBJ-RSP iDoms \*con\*)
	TRaS: (NP-SBJ-RSP iDoms \*T\*)
	xxxSUBJ: ELSE
}